...
public class StatusCode {
	...
	private static void initialize() {
		...
		codes.put(423,
				new StatusCode(423, "Locked (WebDAV; RFC 4918)", "The resource that is being accessed is locked."));
		...
		codes.put(450, new StatusCode(450, "Blocked by Windows Parental Controls (Microsoft)",
		...
		codes.put(509, new StatusCode(509, "Bandwidth Limit Exceeded (Apache Web Server/cPanel)",
		...
		codes.put(598, new StatusCode(598, "(Informal convention) Network read timeout error",
				"Used by some HTTP proxies to signal a network read timeout behind the proxy to a client in front of the proxy."));
		codes.put(440,
				new StatusCode(440, "Login Time-out", "The client's session has expired and must log in again."));
		codes.put(449, new StatusCode(449, "Retry With",
		...
		codes.put(495, new StatusCode(495, "SSL Certificate Error",
	...
	private StatusCode(Integer code, String title, String msg) {
		this.code = code;
		this.title = title;
		this.msg = msg;
	}
