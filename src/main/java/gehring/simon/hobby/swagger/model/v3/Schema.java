...
public class Schema extends SwaggerObject {
   ...
   */
  public Schema(final String reference)
  ...
  /**
   * <p>
   * [This value] can be used to decorate a user interface with
   * information about the data produced by this user interface. [A] description
   * will provide explanation about the purpose of the instance described by this
   * schema.
   * </p>
   *
   * <p style='color:red'>
   ...
   *
   * <p>
   * If "exclusiveMaximum" is true, the a numeric instance SHOULD NOT be
   ...
   * <ul>
   * <li>if "items" is not present, or its value is an object, validation
